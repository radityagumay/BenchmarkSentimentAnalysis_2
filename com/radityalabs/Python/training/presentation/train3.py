...
def load_test():
    with open(path + "/Python/bimbingan_data/train_twitter_corpus_2317_nltk_3.pickle", "rb") as handle:
...
def testing(sentence):
    cl = joblib.load(path + '/Python/bimbingan_data/sklearn-joblib-train-combine-twitter-nltk-3.pkl')
    print(cl.classify(sentence))
    print("Accuracy: {0}".format(cl.accuracy(load_test())))
    cl.show_informative_features(5)

testing(sentence = "this app is good")